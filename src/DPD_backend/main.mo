...
actor class DAO()  {
    ...
    let name : Text = "DaProd DAO";
    var manifesto : Text = "aims to harness the power of the Internet Computer to forge a more independant autonomous sustainable entertainement production and financing future.";
    ...
    let nameToken = "DaPROD Token";
    let symbolToken = "DAPROD";
    ...
    let socialsAuthor: Socials = {
        Twitter = ?"https://twitter.com/daprod_org";
        GitHub = ?"https://github.com/adylitto";
        Linkedin = ?"https://www.linkedin.com/company/daprod";
        Instagram = null;
        TikTok = null;
        OpenChat = null;
    };
    ...
    let images: Images = {
        urlLogo = ?"https://pbs.twimg.com/profile_images/1647283976053063680/xTSk7cgb_400x400.jpg";
        urlBanner = ?"https://pbs.twimg.com/profile_banners/1647232328656101377/1681578100/1500x500";
    };
